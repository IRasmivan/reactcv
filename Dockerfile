...
RUN ls
RUN sudo ./acme.sh/acme.sh --install
RUN sudo ./acme.sh/acme.sh --issue -d rasmivan.com -w /var/www/rasmivan.com
RUN sudo ./acme.sh/acme.sh --installcert -d rasmivan.com \
